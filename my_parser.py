...
parser.add_argument('--budget_size', type=int, default=100, help='query budget size per step.')
parser.add_argument('--total_budget_size', type=int, default=2000, help='total query budget size.')
...
parser.add_argument('--pure', action='store_true', help='use PURE to reduce statistical bias for active learning')
parser.add_argument('--lure', action='store_true', help='use LURE to reduce statistical bias for active learning')
parser.add_argument('--nb_epoch', type=int, default=1e3, help='epochs for meta learning')
